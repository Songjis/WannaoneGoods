...
<link href="resources/category/etc.css" rel="stylesheet" type="text/css" media="all">
    ...
    <img src="resources/img/banner.jpg" id="banner" class="img-responsive" alt="banner" width="100%" height="400"> 
      ...
      <div id="etc">
          ...
          <!-- 탭-->
            ...
            <button type="button" class="btn btn-default" id="tab1">스티커</button>
          <button type="button" class="btn btn-default" id="tab1">카드</button>
