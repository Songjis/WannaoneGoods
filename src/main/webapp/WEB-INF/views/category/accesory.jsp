...
<link href="resources/category/accesory.css" rel="stylesheet" type="text/css" media="all">
    ...
    <img src="resources/img/banner.jpg" id="banner" class="img-responsive" alt="banner" width="100%" height="400"> 
      ...
      <div id="accesory">
          ...
          <!-- 탭-->
            ...
            <button type="button" class="btn btn-default" id="tab1">팔찌</button>
          <button type="button" class="btn btn-default" id="tab1">키링</button>
          <button type="button" class="btn btn-default" id="tab1">에코백</button>
